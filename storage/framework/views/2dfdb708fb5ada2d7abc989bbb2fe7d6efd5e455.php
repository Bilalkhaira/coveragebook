  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('home.setting')); ?>">
  ...
  </aside><!-- End Sidebar--><?php /**PATH /Users/zubairmohsin/code/sites/coveragebook/resources/views/admin/layouts/partials/_sidebar.blade.php ENDPATH**/ ?>