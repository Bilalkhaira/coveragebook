    ...
    <div class="row" id="rws">
      <div class="col-md-9 mt-5 pb-5">
        ...
        <a href="" class="button group button-icon flex-none" type="button" data-toggle="modal" data-target="#modal3">
          <img src="<?php echo e(asset('img/edit.png')); ?>" alt="" width="44" height="44" style="margin-left: 12; margin-bottom: 18px;">
        </a>
      </div>
      <div class="col-md-3">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <a href="" class="btn mt-1" type="button" data-toggle="modal" data-target="#modal1" id="achrcrd">
                <img src="<?php echo e(asset('img/book.png')); ?>" alt="" width="30" height="30" class="mt-0">
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <a href="" class="btn mt-1" type="button" data-toggle="modal" data-target="#modal2" id="achrcrd">
                <img src="<?php echo e(asset('img/circle.png')); ?>" alt="" width="30" height="30" class="mt-1">
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <a href="book matrics.html" class="btn mt-1" id="achrcrd">
                <img src="<?php echo e(asset('img/level.png')); ?>" alt="" width="30" height="30" class="mt-1">
              </a>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        ...
        <a href="front cover.html" class="text-decoration-none">
          <div class="card" id="crd">
            <img src="<?php echo e(asset('img/_20230131194939.jpg')); ?>" alt="" width="100%" height="100%">
      ...
      <div class="col-md-4">
        ...
        <a href="highlights.html" class="text-decoration-none">
          <div class="card text-center p-3" id="crd">
            <img src="<?php echo e(asset('img/star (2).png')); ?>" alt="" width="90" height="90" style="margin-left: 140px; margin-top: 30px;">
      ...
      <div class="col-md-3">
        <a href="#">
          <button type="button" class="btn mt-4 mb-3 pr-2 text-secondary" id="prviw" data-toggle="modal" data-target="#">
            <img src="<?php echo e(asset('img/p box.png')); ?>" alt="" width="24" height="24" style="margin-right: 9; margin-bottom: 2px;">
            Add a New Section
          </button>
        </a>
      </div>
    ...
    <div class="row mt-3">
      <div class="col-md-12">
        <div class="card mb-4" id="crd">
          <div class="row">
            <div class="col-md-12">
              <img src="<?php echo e(asset('img/eye.png')); ?>" alt="" width="30" height="30" style="margin-right: 30px; margin-top: 10px;float: right;">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-8">
              <a href="#" class="text-decoration-none ">
                <img src="<?php echo e(asset('img/you.webp')); ?>" alt="" width="40" height="40" style="margin-left: 30px; margin-top: 60px;margin-bottom: 60px;">
            ...
            <div class="col-md-1 text-center">
              <h6>LAYOUT</h6>
              <div class="card text-lg-center" id="crrds">
                <img src="<?php echo e(asset('img/layout (2).png')); ?>" alt="" width="40px" height="40px" style="margin-left: 15px; margin-top: 10px;margin-bottom: 0px;">
              </div>
              <h6>FULL</h6>
            </div>
...
<?php echo $__env->make('layouts.book_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zubairmohsin/code/sites/coveragebook/resources/views/pages/book/index.blade.php ENDPATH**/ ?>