                        ...
                        <form action="">
                            <div class="pt-3">
                                ...
                                <div style="float: right;">
                                    <button type="submit" class="btn btn-primary"><?php echo e($test == 1 ? 'Add' : 'Edit'); ?></button>
                                </div>
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-body pt-3">
                    ...
                    <div class="tab-content pt-2">
                        <form action="<?php echo e(route('update.satisfiedSection')); ?>" method="POST"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zubairmohsin/code/sites/coveragebook/resources/views/admin/pages/homeSetting.blade.php ENDPATH**/ ?>