    ...
    <section class="wrapper bg-light">
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-16 align-items-center">
          <div class="col-lg-7">
            <figure><img style="width: -webkit-fill-available !important;" class="w-auto" src="<?php echo e(asset('img/illustrations/i8.png')); ?>" srcset="<?php echo e(asset('img/illustrations/i8@2x.png 2x')); ?>" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-lg-7 order-lg-2">
            <figure><img class="w-auto" style="width: -webkit-fill-available !important;" src="<?php echo e(asset('img/illustrations/i7.png')); ?>" srcset="<?php echo e(asset('img/illustrations/i7@2x.png 2x')); ?>" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zubairmohsin/code/sites/coveragebook/resources/views/pages/services/applicationMigrationConversion.blade.php ENDPATH**/ ?>