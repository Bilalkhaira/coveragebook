...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>> I agree to the <a href="#">Terms & Conditions</a> and <a href="">Privacy Policy</a>
                            </label>
                        </div>
...
</html><?php /**PATH /Users/zubairmohsin/code/sites/coveragebook/resources/views/auth/register.blade.php ENDPATH**/ ?>