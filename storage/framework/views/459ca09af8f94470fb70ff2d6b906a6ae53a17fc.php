            ...
            <div class="row mt-2 mb-5 justify-content-center no-gutters">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="" class="btn mt-1" type="button" data-toggle="modal" data-target="#modal1" id="achrcrd">
                                    <img src="<?php echo e(asset('img/layout (2).png')); ?>" alt="" width="24" height="27" class="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="" class="btn mt-1" type="button" data-toggle="modal" data-target="#modal2" id="achrcrd">
                                    <img src="<?php echo e(asset('img/mouth.png')); ?>" alt="" width="24" height="27" class="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="" class="btn mt-1" type="button" data-toggle="modal" data-target="#modal3" id="achrcrd">
                                    <img src="<?php echo e(asset('img/cover.png')); ?>" alt="" width="24" height="27" class="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="" class="btn mt-1" type="button" data-toggle="modal" data-target="#modal4" id="achrcrd">
                                    <img src="<?php echo e(asset('img/circle.png')); ?>" alt="" width="24" height="27" class="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="" class="btn mt-1" type="button" data-toggle="modal" data-target="#modal5" id="achrcrd">
                                    <img src="<?php echo e(asset('img/eye.png')); ?>" alt="" width="24" height="27" class="">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row mt-5 mb-5">
                        <div class="col-md-12">
                            <img src="<?php echo e(asset('img/_20230131194939.jpg')); ?>" alt="" style="border-radius: 20px;height: 100%; width: 100%;">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.book_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zubairmohsin/code/sites/coveragebook/resources/views/pages/book/fount_cover.blade.php ENDPATH**/ ?>