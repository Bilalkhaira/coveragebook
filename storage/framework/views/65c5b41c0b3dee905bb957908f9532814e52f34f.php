        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0 mb-13 mb-md-17">
            ...
            <div class="col-lg-8">
                <div class="row row-cols-2 row-cols-md-3 gx-0 gx-md-8 gx-xl-12 gy-11 mt-n10 brand_img">
                    ...
                    <div class="col">
                        <figure class="px-4 px-lg-3 px-xxl-5"><img src="<?php echo e(asset('img/brands/c9.png')); ?>" alt="" />
                        </figure>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zubairmohsin/code/sites/coveragebook/resources/views/welcome.blade.php ENDPATH**/ ?>