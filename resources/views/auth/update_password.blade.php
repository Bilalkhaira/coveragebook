                ...
                <div class="col-md-12">
                    ...
                    <form method="POST" action="{{ route('reset.password') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password" class="form-control @error('current_password') is-invalid @enderror" name="current_password" value="{{ old('current_password') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password" class="form-control @error('confirmpassword') is-invalid @enderror" name="confirmpassword" required autocomplete="current-confirmpassword">
